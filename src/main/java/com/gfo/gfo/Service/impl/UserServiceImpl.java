package com.gfo.gfo.Service.impl;
...
public class UserServiceImpl implements IUserService {
     ...
     */
    @Override
    public Integer  showCountInfo(Integer day) {
        Integer dayCOUNT = userMapper.findDayCOUNT(day);
        return dayCOUNT;
    }
     ...
     */
    @Override
    public PageResult<User> pageList(UserCondition condition) {
            Page<User> page = PageHelper.startPage(condition.getPage(), condition.getPageSize());
            List<User> talks = userMapper.selectList(condition);
            condition.setTotal(page.getTotal());
            return new PageResult(condition,talks);
    }
